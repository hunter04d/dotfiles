# Generated by Powerlevel10k configuration wizard on 2019-12-28 at 16:51 EET.
...
() {
  ...
  #TODO: add better icons for everything
  ...
  ###########[ vi_mode: vi mode (you don't need this if you've enabled prompt_char) ]###########
  # Foreground color.
  typeset -g POWERLEVEL9K_VI_MODE_FOREGROUND=3
